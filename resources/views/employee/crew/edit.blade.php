                        ...
                        <div>
                            <label class="block text-xl">
                                ...
                                <select id="job-status" name="status"
                                    ...
                                    <option value="inactive" {{$crew->status === 'inactive' ? 'selected' : ''}}>غير فعال </option>
                                </select>
                            </label>
                            @error('status')
                            <span class="text-xs text-red-600 dark:text-red-400">
                        ...
                        <div>
                            <label class="block text-xl">
                                ...
                                <select name="job_id"
                                    ...
                                    @foreach($jobs as $job)
                                        <option value="{{ $job->id }}" {{$job->id === $crew->job_id ? 'selected':''}}>{{ $job->job_name }}</option>
                                    @endforeach
                                </select>
                            </label>
                            @error('job_id')
